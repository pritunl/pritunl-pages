...
const definition: ProductDefinition = {
		...
		client: {
			...
			installers: {
				macos: {
					label: "macOS",
					version: "1.3.4566.62",
					url: "https://github.com/pritunl/pritunl-client/releases/download/$version/Pritunl.pkg.zip",
					hashUrl: "https://raw.githubusercontent.com/pritunl/pritunl-client/master/SHA256",
				},
				windows: {
					label: "Windows",
					version: "1.3.4566.62",
					url: "https://github.com/pritunl/pritunl-client/releases/download/$version/Pritunl.exe",
					hashUrl: "https://raw.githubusercontent.com/pritunl/pritunl-client/master/SHA256",
				},
			},
		},
	...
	pages: {
		...
		"terms": {
			legal: `PRITUNL TERMS OF SERVICE
Last Updated: April 18, 2014

These terms of service ("Terms") apply to your access and use of Pritunl (the "Service") public services including the homepages, documentation and forum. These terms do not apply to the usage of self-hosted software provided by Pritunl. Please read them carefully.

Accepting these Terms

If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you don't agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing "contact@pritunl.com".

Changes to these Terms

We reserve the right to modify these Terms at any time. For instance, we may need to change these Terms if we come out with a new feature or for some other reason.

Whenever we make changes to these Terms, the changes are effective 24 hours after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check Pritunl for changes to these Terms.

If you continue to use the Service after the revised Terms go into effect, then you have accepted the changes to these Terms.

Privacy Policy

For information about how we collect and use information about users of the Service, please check out our privacy policy available at http://pritunl.com.
...
Pritunl makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.
...
IN NO EVENT WILL PRITUNL BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO PRITUNL. THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.

You agree to defend, indemnify and hold us harmless from and against any and all costs, damages, liabilities, and expenses (including attorneys' fees, costs, penalties, interest and disbursements) we incur in relation to, arising from, or for the purpose of avoiding, any claim or demand from a third party relating to your use of the Service or the use of the Service by any person using your account, including any claim that your use of the Service violates any applicable law or regulation, or the rights of any third party, and/or your violation of these Terms.

Governing Law

The validity of these Terms and the rights, obligations, and relations of the parties under these Terms will be construed and determined under and in accordance with the laws of the New York, without regard to conflicts of law principles.

Jurisdiction

You expressly agree that exclusive jurisdiction for any dispute with the Service or relating to your use of it, resides in the courts of the New York and you further agree and expressly consent to the exercise of personal jurisdiction in the courts of the New York in connection with any such dispute including any claim involving Service. You further agree that you and Service will not commence against the other a class action, class arbitration or other representative action or proceeding.
...
These Terms constitute the entire agreement between you and Pritunl regarding the use of the Service, superseding any prior agreements between you and Pritunl relating to your use of the Service.

Feedback

Please let us know what you think of the Service, these Terms and, in general, Pritunl. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, Pritunl, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.

Questions & Contact Information

Questions or comments about the Service may be directed to us at the email address "contact@pritunl.com".`,
		},
		"privacy": {
			legal: `PRITUNL PRIVACY POLICY
Last Revised: April 18, 2014

Our privacy policy applies to information we collect when you use or access Pritunl public services including the homepages, documentation and forum. This policy does not apply to the usage of self-hosted software provided by Pritunl. We may change this privacy policy from time to time. Whenever we make changes to this privacy policy, the changes are effective 24 hours after we post the revised privacy policy (as indicated by revising the date at the top of our privacy policy). We encourage you to review our privacy policy whenever you access our services to stay informed about our information practices and the ways you can help protect your privacy.
...
To enforce applicable user agreements or policies, including our Terms of Service http://pritunl.com; and to protect us, our users or the public from harm or illegal activities;
In connection with any merger, sale of Pritunl assets, financing or acquisition of all or a portion of our business to another company; and
...
California law permits residents of California to request certain details about how their information is shared with third parties for direct marketing purposes. If you are a California resident and would like to make such a request, please contact us at "contact@pritunl.com". However, please note that under the law, Services such as ours that permit California residents to opt in to, or opt out of, this type of sharing are not required to provide such information upon receiving a request, but rather may respond by notifying the user of his or her right to prevent the disclosure. To opt out of having information about you shared with third parties for direct marketing purposes, please please contact us at "contact@pritunl.com".

Contact Us

If you have any questions about this privacy policy, please contact us at: "contact@pritunl.com".`,
		},
	},
}

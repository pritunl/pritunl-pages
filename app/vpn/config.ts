...
const definition: ProductDefinition = {
	config: {
		...
		repositories: [
			{ type: "vpn", distribution: "arch", version: "", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "amazon", version: "2023", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "alma", version: "8", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "alma", version: "9", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "alma", version: "10", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "oracle", version: "8", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "oracle", version: "9", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "oracle", version: "10", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "rocky", version: "8", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "rocky", version: "9", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "rocky", version: "10", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "debian", version: "12", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "debian", version: "13", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "ubuntu", version: "20.04", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "ubuntu", version: "22.04", package: "pritunl", mongoVersion: "8.2" },
			{ type: "vpn", distribution: "ubuntu", version: "24.04", package: "pritunl", mongoVersion: "8.2" },
		],

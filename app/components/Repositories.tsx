					...
					<div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4">
						{installers.macos && (
							<div className="rounded-lg bg-white/2.5 ring-1 ring-inset ring-white/10 p-6 text-center">
								...
								<p className="mt-1 text-base text-gray-400">v{installers.macos.version}</p>
								<div className="mt-2 inline-flex flex-col items-stretch gap-3">
									<a
										href={installers.macos.hashUrl}
										target="_blank"
										rel="noopener noreferrer"
										className="inline-flex items-center justify-center rounded-md bg-white/5 px-4 py-2 text-base font-semibold text-gray-300 ring-1 ring-inset ring-white/10 hover:bg-white/10 transition-colors"
									>
										SHA-256 Checksum
									</a>
									<a
										href={installers.macos.url.replace("$version", installers.macos.version)}
										className="inline-flex items-center justify-center rounded-md bg-indigo-500 px-4 py-2.5 text-base font-semibold text-white shadow-xs hover:bg-indigo-400 transition-colors"
									>
										Download Pkg
									</a>
								</div>
						...
						{installers.windows && (
							<div className="rounded-lg bg-white/2.5 ring-1 ring-inset ring-white/10 p-6 text-center">
								...
								<p className="mt-1 text-base text-gray-400">v{installers.windows.version}</p>
								<div className="mt-2 inline-flex flex-col items-stretch gap-3">
									<a
